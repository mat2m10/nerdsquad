...
board_chess.save
board_chess.photo.attach(io: File.open('app/assets/images/chess/chessboard.jpg'), filename:"board-#{board.id}-image")

puts "Adding chess pieces..."

chess_piece_hash = { 
    'pion blanc 1' => 'app/assets/images/chess/Chess_plt60.png',
    'pion blanc 2' => 'app/assets/images/chess/Chess_plt60.png',
    'pion blanc 3' => 'app/assets/images/chess/Chess_plt60.png',
    'pion blanc 4' => 'app/assets/images/chess/Chess_plt60.png',
    'pion blanc 5' => 'app/assets/images/chess/Chess_plt60.png',
    'pion blanc 6' => 'app/assets/images/chess/Chess_plt60.png',
    'pion blanc 7' => 'app/assets/images/chess/Chess_plt60.png',
    'pion blanc 8' => 'app/assets/images/chess/Chess_plt60.png',

    'tour blanc 1' => 'app/assets/images/chess/Chess_rlt60.png',
    'tour blanc 2' => 'app/assets/images/chess/Chess_rlt60.png',

    'fou blanc 1' => 'app/assets/images/chess/Chess_blt60.png',
    'fou blanc 2' => 'app/assets/images/chess/Chess_blt60.png',

    'cheval blanc 1' => 'app/assets/images/chess/Chess_nlt60.png',
    'cheval blanc 2' => 'app/assets/images/chess/Chess_nlt60.png',

    'roi blanc 1' => 'app/assets/images/chess/Chess_klt60.png',
    'reine blanc 1' => 'app/assets/images/chess/Chess_qlt60.png',

    'pion noir 1' => 'app/assets/images/chess/Chess_pdt60.png',
    'pion noir 2' => 'app/assets/images/chess/Chess_pdt60.png',
    'pion noir 3' => 'app/assets/images/chess/Chess_pdt60.png',
    'pion noir 4' => 'app/assets/images/chess/Chess_pdt60.png',
    'pion noir 5' => 'app/assets/images/chess/Chess_pdt60.png',
    'pion noir 6' => 'app/assets/images/chess/Chess_pdt60.png',
    'pion noir 7' => 'app/assets/images/chess/Chess_pdt60.png',
    'pion noir 8' => 'app/assets/images/chess/Chess_pdt60.png',

    'tour noir 1' => 'app/assets/images/chess/Chess_rdt60.png',
    'tour noir 2' => 'app/assets/images/chess/Chess_rdt60.png',

    'fou noir 1' => 'app/assets/images/chess/Chess_bdt60.png',
    'fou noir 2' => 'app/assets/images/chess/Chess_bdt60.png',

    'cheval noir 1' => 'app/assets/images/chess/Chess_ndt60.png',
    'cheval noir 2' => 'app/assets/images/chess/Chess_ndt60.png',

    'roi noir 1' => 'app/assets/images/chess/Chess_kdt60.png',
    'reine noir 1' => 'app/assets/images/chess/Chess_qdt60.png',
    }
...
Piece.where(name: 'pion blanc 1').posX = 50
Piece.where(name: 'pion blanc 1').posY = 50
Piece.where(name: 'pion blanc 2').posX = 100
Piece.where(name: 'pion blanc 2').posY = 50
Piece.where(name: 'pion blanc 3').posX = 150
Piece.where(name: 'pion blanc 3').posY = 50
Piece.where(name: 'pion blanc 4').posX = 200
Piece.where(name: 'pion blanc 4').posY = 50
Piece.where(name: 'pion blanc 5').posX = 250
Piece.where(name: 'pion blanc 5').posY = 50
Piece.where(name: 'pion blanc 6').posX = 300
Piece.where(name: 'pion blanc 6').posY = 50
Piece.where(name: 'pion blanc 7').posX = 350
Piece.where(name: 'pion blanc 7').posY = 50
Piece.where(name: 'pion blanc 8').posX = 400
Piece.where(name: 'pion blanc 8').posY = 50
Piece.where(name: 'tour blanc 1').posX = 50
Piece.where(name: 'tour blanc 1').posY = 50
Piece.where(name: 'cheval blanc 1').posX = 100
Piece.where(name: 'cheval blanc 1').posY = 100
Piece.where(name: 'fou blanc 1').posX = 150
Piece.where(name: 'fou blanc 1').posY = 100
Piece.where(name: 'reine blanc 1').posX = 200
Piece.where(name: 'reine blanc 1').posY = 100
Piece.where(name: 'roi blanc 1').posX = 250
Piece.where(name: 'roi blanc 1').posY = 100
Piece.where(name: 'fou blanc 2').posX = 300
Piece.where(name: 'fou blanc 2').posY = 100
Piece.where(name: 'cheval blanc 2').posX = 350
Piece.where(name: 'cheval blanc 2').posY = 100
Piece.where(name: 'tour blanc 2').posX = 400
Piece.where(name: 'tour blanc 2').posY = 100
